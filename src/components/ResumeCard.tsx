const ResumeCard = ({ title, subTitle, result, des }: any) => {
  return (
    <div className="w-50% h-1/4 group flex">
      <div className="w-10 h-[30px] bgOpacity mt-16 relative">
      ...
      <div className="w-full bg-black bg-opacity-20 hover:bg-opacity-30 duration-300  rounded-lg p-4 lgl:px-10 flex flex-col justify-center gap-6 lgl:gap-10 shadow-shadowOne">
        <div className="flex flex-col lgl:flex-row justify-around gap-4 lgl:gap-0 lgl:items-center">
          <div>
        ...
        <p className="text-sm md:text-base font-small text-gray-400 group-hover:text-gray-300 duration-300">
          {des}
        </p>
      </div>
    </div>
